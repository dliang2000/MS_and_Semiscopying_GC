...
ggc_thread_local struct GGGGC_Pool *ggggc_fromPool;
ggc_thread_local struct GGGGC_Pool *ggggc_toPool;
ggc_thread_local struct GGGGC_Pool *ggggc_pool;
ggc_size_t poolOrder;
