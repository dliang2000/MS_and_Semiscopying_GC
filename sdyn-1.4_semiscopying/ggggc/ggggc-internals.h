...
extern ggc_thread_local struct GGGGC_Pool *ggggc_fromPool;

extern ggc_thread_local struct GGGGC_Pool *ggggc_toPool;

extern ggc_thread_local struct GGGGC_Pool *ggggc_pool;

extern ggc_size_t poolOrder;
